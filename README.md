...
## 关于公众号“稳扎稳打学AI”
- **公众号介绍**：关注我，每天为你精选推荐算法paper，帮助你稳扎稳打地学习AI。公众号由思达-刘明星（微信: lmxhappy）运营，内容聚焦于推荐系统、机器学习和大模型等前沿领域。
- **paper推荐原则**：我们优先选择高影响力、实用性强的论文，包括但不限于LLM在推荐中的应用、搜索词推荐、eBay等实际案例分析。
